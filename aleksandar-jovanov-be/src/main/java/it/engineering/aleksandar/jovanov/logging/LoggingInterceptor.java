package it.engineering.aleksandar.jovanov.logging;
...
public class LoggingInterceptor {
	  @Before(value = "@annotation(it.engineering.aleksandar.jovanov.logging.Loggable)")
	    ...
	    @AfterReturning(value = "@annotation(it.engineering.aleksandar.jovanov.logging.Loggable)", returning = "returnValue")
	    ...
	    @AfterThrowing(pointcut = "@annotation(it.engineering.aleksandar.jovanov.logging.Loggable)", throwing = "ex")
